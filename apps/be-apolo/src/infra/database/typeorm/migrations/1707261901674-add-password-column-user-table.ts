...
export class AddPasswordColumnUserTable1707261901674
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'DROP INDEX `UQ_cace4a159ff9f2512dd42373760` ON `user`',
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `UQ_cace4a159ff9f2512dd42373760` ON `user` (`id`)',
    )
  }
}
